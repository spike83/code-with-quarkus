...
import io.spoud.mobi.telemetrie.schema.AnomalyConfigBeat;
...
public class AnomalyConfigBeatRawProcessor extends AnomalyConfigBeat implements RawProcessor<AnomalyConfigBeatRawProcessor> {

  // register type in processors registry
  static {
    RawDispatcher.processorsRegistry.put("69", AnomalyConfigBeatRawProcessor.class);
  }
  ...
  @Override
  @JsonIgnore
  public String extractKey(final SpoudContext<AnomalyConfigBeatRawProcessor> sc) {
  ...
  @Override
  @JsonIgnore
  public void process(final SpoudContext<AnomalyConfigBeatRawProcessor> sc,
