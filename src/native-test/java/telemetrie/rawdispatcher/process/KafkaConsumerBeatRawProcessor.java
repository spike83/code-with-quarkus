...
import io.spoud.mobi.telemetrie.schema.KafkaConsumerBeat;
...
public class KafkaConsumerBeatRawProcessor extends KafkaConsumerBeat implements RawProcessor<KafkaConsumerBeatRawProcessor> {

  // register type in processors registry
  static {
    RawDispatcher.processorsRegistry.put("64", KafkaConsumerBeatRawProcessor.class);
  }
  ...
  @Override
  @JsonIgnore
  public String extractKey(final SpoudContext<KafkaConsumerBeatRawProcessor> sc) {
  ...
  @Override
  @JsonIgnore
  public void process(final SpoudContext<KafkaConsumerBeatRawProcessor> sc,
  ...
  @Override
  public void checkStage(final SpoudContext<KafkaConsumerBeatRawProcessor> sc) {
    // no stage in beat
  }
