...
import io.spoud.mobi.telemetrie.schema.KafkaProducerBeat;
...
public class KafkaProducerBeatRawProcessor extends KafkaProducerBeat implements RawProcessor<KafkaProducerBeatRawProcessor> {

  // register type in processors registry
  static {
    RawDispatcher.processorsRegistry.put("63", KafkaProducerBeatRawProcessor.class);
  }
  ...
  @Override
  @JsonIgnore
  public String extractKey(final SpoudContext<KafkaProducerBeatRawProcessor> sc) {
  ...
  @Override
  @JsonIgnore
  public void process(final SpoudContext<KafkaProducerBeatRawProcessor> sc,
      boolean throttlingEnabled) {
    RawProcessor.super.process(sc, throttlingEnabled);
    normalizeStageCaller();
    setNewStage(convertToNewStage(getStageCaller()));
  }
  ...
  @Override
  public void checkStage(final SpoudContext<KafkaProducerBeatRawProcessor> sc) {
    // no stage in beat
  }
