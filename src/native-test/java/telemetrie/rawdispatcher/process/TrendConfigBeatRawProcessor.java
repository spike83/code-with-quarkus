...
import io.spoud.mobi.telemetrie.schema.TrendConfigBeat;
...
public class TrendConfigBeatRawProcessor extends TrendConfigBeat implements RawProcessor<TrendConfigBeatRawProcessor> {

  // register type in processors registry
  static {
    RawDispatcher.processorsRegistry.put("70", TrendConfigBeatRawProcessor.class);
  }
  ...
  @Override
  @JsonIgnore
  public String extractKey(final SpoudContext<TrendConfigBeatRawProcessor> sc) {
  ...
  @Override
  @JsonIgnore
  public void process(final SpoudContext<TrendConfigBeatRawProcessor> sc, boolean throttlingEnabled) {
